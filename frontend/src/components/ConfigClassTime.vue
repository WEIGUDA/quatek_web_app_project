  ...
  <div>
    <form class="form-inline">
      ...
      <div class="input-group mb-2 mr-sm-2">
        <input type="text" class="form-control" id="class_time_name" v-model="class_time_name" placeholder="班别名称">

      </div>

      <label class="sr-only" for="class_time_from">班别开始时间</label>
      <div class="input-group mb-2 mr-sm-2">
        <input type="text" class="form-control" id="class_time_from" v-model="class_time_from" placeholder="班别开始时间">

      </div>

      <label class="sr-only" for="class_time_to">班别结束时间</label>
      <div class="input-group mb-2 mr-sm-2">
        <input type="text" class="form-control" id="class_time_to" v-model="class_time_to" placeholder="班别结束时间">
        ...
        <table class="table table-striped table-responsive-md">
          ...
          <tbody v-if="class_times.length">
            <tr v-for="class_time in class_times" :key="class_time._id.$oid">
              ...
              <td>
                <button type="button" class="btn btn-secondary btn-quatek btn-sm" @click="delete_class_time(class_time._id.$oid)">
